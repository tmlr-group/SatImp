from dataloader.data_module_base import WMDPDataset, UnlearnDataset, unlearncollector
from dataloader.dataloader_base import CustomTrainerForgetting, custom_data_collator_forget_wmdp
import torch
...
def main(cfg):
    ...
    max_steps = 125 #int(cfg.num_epochs*len(torch_format_dataset))//(batch_size*gradient_accumulation_steps*num_devices)
