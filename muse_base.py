from dataloader.muse_dataset import ForgetRetainDataset
from dataloader.dataloader_base import CustomTrainerForgetting
import torch
...
@hydra.main(version_base=None, config_path="config", config_name="forget_base")
def main(cfg):
    ...
    torch_format_dataset= ForgetRetainDataset(
        cfg.data_file,
        tokenizer=tokenizer,
        retain_file_path=cfg.retain_data_file,
        max_len=cfg.max_len
    )
    ...
    training_args = transformers.TrainingArguments(
            ...
            save_strategy="epoch" if cfg.save_model and (not cfg.eval_only) else "no",
    ...
    if path_found:
        ...
        oracle_model = AutoModelForCausalLM.from_pretrained(model_id, use_flash_attention_2=model_cfg["flash_attention2"]=="true", torch_dtype=torch.bfloat16)        
    ...
    trainer = CustomTrainerForgetting(
        ...
        args=training_args,
        data_collator=torch_format_dataset.get_collate_fn(),
