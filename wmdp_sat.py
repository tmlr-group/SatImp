...
from dataloader.dataloader_sat import CustomTrainerForgetting, custom_data_collator_forget_wmdp
import torch
...
@hydra.main(version_base=None, config_path="config", config_name="forget_mask")
def main(cfg):
