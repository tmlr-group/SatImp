from dataloader.data_module_imp import TextForgetDatasetQA2
from dataloader.dataloader_imp import CustomTrainerForgetting, custom_data_collator_forget_key_human
import torch
...
@hydra.main(version_base=None, config_path="config", config_name="forget_org")
def main(cfg):
    ...
    max_length = 500
    torch_format_dataset = TextForgetDatasetQA2(cfg.data_path, tokenizer=tokenizer, model_family = cfg.model_family, max_length=max_length, split=cfg.split, loss_type=cfg.forget_loss,soft_index=cfg.hyper_param)
    #pdb.set_trace()
    ...
    trainer = CustomTrainerForgetting(
        ...
        args=training_args,
        data_collator=custom_data_collator_forget_key_human,
