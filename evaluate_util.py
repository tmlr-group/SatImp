...
from data_module_imp import TextDatasetQA, custom_data_collator, get_batch_loss, custom_data_collator_with_indices
import torch
    ...
    for attempt in range(3):
        ...
        # do thing
            if cfg.use_pretrained:
                ...
                model = AutoModelForCausalLM.from_pretrained(cfg.model_path, config=config, use_flash_attention_2='false', torch_dtype=torch.bfloat16, trust_remote_code = True, device_map=device_map)
